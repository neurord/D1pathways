...
#java -jar  /home/neuroware/stochdif/neurord-3.2.3-all-deps.jar --ic-time -1 --ic Model_SPNspineAChm4R_Gshydr5_GapD-nostim.h5 -v -s injections -Dneurord.trials=3 Model_SPNspineAChm4R_Gshydr5_GapD_tol001-bathDa.xml ss_bath/ &
...
#java -jar  /home/neuroware/stochdif/neurord-3.2.3-all-deps.jar -v -s injections -Dneurord.trials=3 Model_SPNspineAChm4R_GapD_calpain-stim20hz-noReb_lowDaDec3.xml &
#java -jar  /home/neuroware/stochdif/neurord-3.2.3-all-deps.jar -v -s injections -Dneurord.trials=3 Model_SPNspineAChm4R_GapD_calpain-stimtheta-noReb_DaDec1.xml 
#java -jar  /home/neuroware/stochdif/neurord-3.2.3-all-deps.jar -v -s injections -Dneurord.trials=3 Model_SPNspineAChm4R_GapD_pPDE1st-stim20hz-noReb_lowDaDec3.xml &
#java -jar  /home/neuroware/stochdif/neurord-3.2.3-all-deps.jar -v -s injections -Dneurord.trials=3 Model_SPNspineAChm4R_GapD_pPDE1st-stimtheta-noReb_DaDec1.xml
#java -jar  /home/neuroware/stochdif/neurord-3.2.3-all-deps.jar -v -s injections -Dneurord.trials=3 Model_SPNspineAChm4R_GapD_calpain-bathCa.xml &
#java -jar  /home/neuroware/stochdif/neurord-3.2.3-all-deps.jar -v -s injections -Dneurord.trials=3 Model_SPNspineAChm4R_GapD_calpain-bathDaCa.xml
...
java -jar  /home/neuroware/stochdif/neurord-3.2.3-all-deps.jar -Dneurord.SDRun.tolerance=0.01 -ic-time -1 --ic Model_SPNspineAChm4R_Gshydr5_GapD-nostim.h5 -v -s injections -Dneurord.trials=3 Model_SPNspineAChm4R_Gshydr5_GapD-bathDa.xml ss_bath/Model_SPNspineAChm4R_Gshydr5_GapD-bathDa-tol01 &
java -jar  /home/neuroware/stochdif/neurord-3.2.3-all-deps.jar -Dneurord.SDRun.tolerance=0.005 -ic-time -1 --ic Model_SPNspineAChm4R_Gshydr5_GapD-nostim.h5 -v -s injections -Dneurord.trials=3 Model_SPNspineAChm4R_Gshydr5_GapD-bathDa.xml ss_bath/Model_SPNspineAChm4R_Gshydr5_GapD-bathDa-tol005 
java -jar  /home/neuroware/stochdif/neurord-3.2.3-all-deps.jar -Dneurord.SDRun.tolerance=0.002 -ic-time -1 --ic Model_SPNspineAChm4R_Gshydr5_GapD-nostim.h5 -v -s injections -Dneurord.trials=3 Model_SPNspineAChm4R_Gshydr5_GapD-bathDa.xml ss_bath/Model_SPNspineAChm4R_Gshydr5_GapD-bathDa-tol002 &
java -jar  /home/neuroware/stochdif/neurord-3.2.3-all-deps.jar -Dneurord.SDRun.tolerance=0.001 -ic-time -1 --ic Model_SPNspineAChm4R_Gshydr5_GapD-nostim.h5 -v -s injections -Dneurord.trials=3 Model_SPNspineAChm4R_Gshydr5_GapD-bathDa.xml ss_bath/Model_SPNspineAChm4R_Gshydr5_GapD-bathDa-tol001 

#depending on results, may need to (A) adjust parameters, e.g. PDE2, (B) check whether tolerance affects other sims, and (B) decrease tolerance for all other sims
